export const CONFIG = {
  ...
  TEMPLATE_SERTIFIKAT_ID:'1GxRuZiDcipHx4I2tgI3jzB7py3eWIQZ6_iVSe6OtyEA',
  SHARED_DRIVE_ID:'17CGvjjslRnIeaVCALvmEgM_BlnZ2zwfy',
};
...
export const DEFAULT_JENIS_SURAT = [
  ...
  { nama:'Sertifikat', format:'YPUU/SERT' },
];
...
export const HEADERS = {
  ...
  Requests: ['id','requester_name','requester_username','division','position','request_type','document_type','document_number','perihal','target_signer','file_url','file_name','status','approved_by','approved_at','rejected_by','rejected_at','rejection_reason','created_at','forwarded_by','forwarded_at','read_by_requester', 'departemen', 'posisi_ttd', 'nama_kegiatan', 'tanggal_kegiatan', 'daftar_peserta'], // <--- TAMBAHKAN 3 KOLOM INI DI AKHIR
  Divisi: ['nama'],
  Jabatan: ['nama'],
